import{eB as Ie,jE as ae,e9 as Ue,fC as $e,x as q,jF as Le,jG as ke,jH as Ne,h8 as He,jI as qe,jJ as Ge,eb as x,a9 as Ve,a_ as Pe,o as Ce,em as We,cc as K,ea as Z,eR as Y,iT as je,eg as oe,eh as Ke,ee as Ye,ip as Xe,ir as Je,az as le,go as Qe,iI as Ze,jK as et,jL as tt,F as it,iK as de,jM as rt,_ as ue,iL as st,u as nt,e6 as at,k as X,P as ot,av as he,cx as lt,jN as dt,N as ce}from"./index-dfe4d42d.js";import{c as ut}from"./ExpandedCIM-4553bdd3.js";import{p as ht,s as ct}from"./imageUtils-6d256b93.js";import{t as _t,b as ft,o as _e,h as mt,i as pt}from"./Container-17b68520.js";import{i as gt}from"./BufferPool-aeca0f8a.js";import{T as B,E as S,S as $}from"./color-628a0e8f.js";import{g as vt,a as k,h as G,w as A,d as bt,m as xt}from"./WGLContainer-63e30817.js";import{L as E}from"./enums-fb086c25.js";import{e as wt,a as W,f as ee}from"./ProgramTemplate-b90e7b4c.js";import{n as U}from"./programUtils-4835c55e.js";import{e as fe,r as yt,t as Tt,a as Ft,m as Bt,J as Et,n as Ot,b as Rt,c as Mt}from"./MagnifierPrograms-ab6fcbfa.js";import{d as vs,y as bs}from"./MagnifierPrograms-ab6fcbfa.js";import{h as te,E as C,a as ie,i as Pt}from"./FramebufferObject-11d118ad.js";import{R as v,E as H,F as re,O as j,I as J,L as D,C as me,D as O,B as se,G as T,U as ne,P as Ct}from"./enums-bdecffa2.js";import{o as pe,N as St}from"./RenderingContext-402e4565.js";import{z as At,q as Dt,Q as zt,E as It,F as Ut,L as N,M as $t,_ as Se,R as ge}from"./definitions-5574f3b3.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as L}from"./Texture-f95d4e25.js";import{r as ws}from"./GraphicsView2D-cdfcd37b.js";import{i as Ts}from"./GraphicContainer-42132332.js";import{t as be}from"./requestImageUtils-02bb3863.js";import"./BidiEngine-9a40f2f4.js";import"./visualVariablesUtils-d034d8c8.js";import"./OptimizedGeometry-d94e541f.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./utils-9a8de973.js";import"./GeometryUtils-40616d63.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-3746adc8.js";import"./floatRGBA-d8066688.js";import"./AttributeStoreView-45d33124.js";import"./TiledDisplayObject-fe67ecec.js";import"./diffUtils-bbf5ba7d.js";import"./labelingInfo-d5ce8c46.js";import"./LabelClass-ee8ff0ef.js";import"./labelUtils-a50f3602.js";import"./defaultsJSON-b087dd4d.js";import"./jsonUtils-f13e839b.js";import"./clusterUtils-bc690dd1.js";import"./MD5-715f37cd.js";import"./SizeVariable-aba63b8a.js";import"./colorRamps-c95c47a3.js";import"./LegendOptions-9dd9bdee.js";import"./util-7d7d5193.js";import"./heatmapUtils-339dd66a.js";import"./vec4f64-3c9d0901.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-9c20e96e.js";import"./featureConversionUtils-17f64791.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./rasterizingUtils-d6f3dcd0.js";import"./pbf-4963ee00.js";import"./imageutils-ea016fb2.js";import"./Matcher-5b864048.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-5db9284f.js";import"./LRUCache-c11c9d99.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-3227e24b.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-7fd5c211.js";import"./FieldsIndex-c919e639.js";import"./UnknownTimeZone-03c79817.js";import"./TimeOnly-a22a1873.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-5fb0fa6f.js";import"./projectionSupport-0821404a.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-823f9ac8.js";import"./FeatureContainer-5bb38090.js";import"./TileContainer-6839f28c.js";import"./vec3f32-2da9db36.js";let Lt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=ht(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return ut(e)}},kt=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return Le(f),ke(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
